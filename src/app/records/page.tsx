...
const ligaRecords: Record[] = [
  {
    ...
    unit: '回',
    label: 'ラ・リーガ最多優勝',
    desc: '2023-24シーズン終了時点でのリーグ最多優勝記録。2位のバルセロナ（27回）に8回の差をつけている。',
  },
  {
    number: '100',
    unit: '点',
  ...
  },
  {
    number: '50',
    unit: 'ゴール',
    label: 'ラ・リーガ1シーズン最多個人ゴール（ロナウド・2010-11）',
    desc: 'クリスティアーノ・ロナウドが2010-11シーズンに樹立したラ・リーガ個人最多ゴール記録。1試合平均1.3ゴールという驚異的なペース。',
  },
  {
    number: '11',
    unit: '対 2',
