...
const QUESTIONS_LV3: QuizQuestion[] = [
  ...
  { id: 'lv3_20', question_text: '2000年代にマドリーでCLとリーガを同シーズン制覇したのは何年？', choices: ['2001-02', '2002-03', '2003-04', '2004-05'], correct_answer: '2001-02', level: 3, genre: 'legends', emoji: '🏆', hint: 'ジダン加入翌年。ジダンのボレーゴールが決まったCL制覇のシーズン' },
