...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: '約7分',
    excerpt:
      '2018年、ルカ・モドリッチはクリスティアーノ・ロナウドとリオネル・メッシが10年以上独占してきたバロンドールを奪取した。165cmの小柄なクロアチア人が示した「サッカーの本質」とは何か。レアル・マドリードの黄金期を支えた職人の物語。',
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '165cmの小柄な職人が証明したこと——それは「サッカーはフィジカルではなく、知性で行うスポーツである」という普遍の真理だ。モドリッチの名は、レアル・マドリードの歴史に永遠に刻まれる。',
        ],
      },
    ],
  },
